...
MAS is intentionally minimal.

It standardizes only the expression of model identity in a URI fragment, enabling portable configuration while preserving full backward compatibility with existing HTTP infrastructure.
