...
Sure! [Conversation.sh is six lines of bash](https://github.com/day50-dev/llcat/blob/main/conversation.sh). Even has inspectable tool calls. Realime Observability with Human-in-the-Loop! Wowza! I'll settle for merely $40 million.
